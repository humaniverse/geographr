...
-   Add a script to generate the data in `/data-raw`, adding
    ...
    data set, `R/sysdata.rda`, that contains a list of URL parameters
    used to generate data sets. `R/sysdata.rda` is generated by
    `/data-raw/url-parameters.R`. Be sure to update this file with the
    URL parameters used to generate any new data sets.
