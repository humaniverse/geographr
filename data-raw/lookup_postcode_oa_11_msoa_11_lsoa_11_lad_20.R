...
query_url <-
  query_urls |>
  filter(id == "postcode_oa_11_lsoa_11_msoa_11_lad_20") |>
  pull(query)
...
# Rename
lookup_postcode_oa_11_lsoa_11_msoa_11_lad_20 <- postcode_oa_lsoa_msoa_lad

# Save output to data/ folder
usethis::use_data(lookup_postcode_oa_11_lsoa_11_msoa_11_lad_20, overwrite = TRUE)
