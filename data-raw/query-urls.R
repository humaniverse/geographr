...
query_urls <-
  tribble(
    ...
    # Points
    "points", "nhs_trusts_22", "23.04.22", "OGLv3", "https://files.digital.nhs.uk/assets/ods/current/etr.zip", "https://digital.nhs.uk/services/organisation-data-service/file-downloads/other-nhs-organisations",

    # Lookups
    "lookup", "lad_20_cauth_20", "27.11.2020","OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/LAD20_CAUTH20_EN_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/ons::local-authority-district-to-combined-authority-december-2020-lookup-in-england/about",
    "lookup", "lad_19_counties_ua_19", "28.03.19", "OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/LTLA19_UTLA19_EW_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/lower-tier-local-authority-to-upper-tier-local-authority-april-2019-lookup-in-england-and-wales/explore",
    "lookup", "lad_20_counties_ua_20", "30.11.20", "OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/LTLA20_UTLA20_EW_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/lower-tier-local-authority-to-upper-tier-local-authority-december-2020-lookup-in-england-and-wales/explore",
    "lookup", "lad_21_counties_ua_21", "30.03.21", "OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/LTLA21_UTLA21_EW_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/lower-tier-local-authority-to-upper-tier-local-authority-april-2021-lookup-in-england-and-wales/explore",
    "lookup", "lad_21_fra_21", "30.03.21","OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/LAD21_FRA21_EW_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/ons::local-authority-district-to-fire-and-rescue-authority-april-2021-lookup-in-england-and-wales/about",
    "lookup", "lad_lad", "31.12.22", "OGLv3", "https://www.arcgis.com/sharing/rest/content/items/a8807f0914234a52b00edecdc34428fa/data", "https://geoportal.statistics.gov.uk/datasets/code-history-database-december-2021-for-the-united-kingdom/about",
    "lookup", "lsoa_11_lad_21", "25.11.21", "OGLv3", "https://www.arcgis.com/sharing/rest/content/items/81bcefcd048e43acb948ad069c5e06c0/data", "https://geoportal.statistics.gov.uk/documents/ons::lower-layer-super-output-area-2011-to-ward-2021-to-lad-2021-lookup-in-england-and-wales/about",
    "lookup", "lsoa_11_msoa_11", "03.08.18", "OGLv3", "https://opendata.arcgis.com/datasets/fe6c55f0924b4734adf1cf7104a0173e_0.csv", "http://geoportal.statistics.gov.uk/datasets/fe6c55f0924b4734adf1cf7104a0173e_0",
    "lookup", "msoa_11_lad_19", "18.12.19", "OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/MSOA11_WD19_LAD19_EW_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/ons::middle-layer-super-output-area-2011-to-ward-to-lad-december-2019-lookup-in-england-and-wales/about",
    "lookup", "msoa_11_lad_20", "30.11.20", "OGLv3", "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/MSOA11_WD20_LAD20_EW_LU/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", "https://geoportal.statistics.gov.uk/datasets/ons::middle-layer-super-output-area-2011-to-ward-to-lad-december-2020-lookup-in-england-and-wales/about",
    "lookup", "msoa_11_lad_21", "25.11.21", "OGLv3", "https://www.arcgis.com/sharing/rest/content/items/b4c0247ef8564d419bdeb1eda13f2d0f/data" , "https://geoportal.statistics.gov.uk/documents/middle-layer-super-output-area-2011-to-ward-to-lad-december-2021-lookup-in-england-and-wales/about",
    "lookup", "postcode_oa_11_lsoa_11_msoa_11_lad_20", "23.11.20", "OGLv3", "https://www.arcgis.com/sharing/rest/content/items/9f629cd0c2fb42beb0d79a474fee4776/data", "https://geoportal.statistics.gov.uk/datasets/9f629cd0c2fb42beb0d79a474fee4776/about",
