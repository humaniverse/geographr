...
#' Wales Local Health Boards (2022)
#'
#' A data set containing 2022 Local Health Board geometries for Wales and their
#' associated names and codes.
#'
#' @format A data frame of class "sf" with 7 rows and 3 variables:
#' \describe{
...
#' Middle Layer Super Output Areas equivalents for the UK
#'
#' A data set containing  Middle Super Output Area (MSOA) equivalent geometries and
#' their associated names and codes for the UK. Super generalised (200m) boundaries were
#' simplified using the Visvalingam algorithm set to a weighting of 0.7 with a
#' retaining proportion of 0.05 points.
#'
#' @format A data frame of class "sf" with 9,393 rows and 3 variables:
#' \describe{
#'   \item{msoa21_name}{MSOA name}
#'   \item{msoa21_code}{MSOA code}
#'   \item{geometry}{multipolygon coordinates}
...
#' Data Zone (2021) to Super Data Zone (2021) to District Electoral Areas (2019)
#' to Local Government Districts (2014) Lookup
#'
#' A data set containing a lookup between Data Zones (Output Areas), Super Data Zones (LSOA),
#' District  Electoral Areas and Local Government Districts (Local Authority) in Northern Ireland
#'
#' @format A data frame of class "tbl" with 3,780 rows and 8 variables:
#' \describe{
